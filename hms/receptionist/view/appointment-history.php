...
?>
    <tr>
        ...
        <td class="hidden-xs"><?php echo $row['patientEmail'];?></td>
												<td class="hidden-xs"><?php echo $row['patientNumber'];?></td>
        <td class="hidden-xs"><?php echo $row['patientAge'];?></td>
        <td class="hidden-xs"><?php echo $row['consultancyFees'];?></td>
        <td class="hidden-xs"><?php echo $row['appointmentDate'];?></td>
        <td class="hidden-xs"><?php echo $row['appointmentTime'];?></td>
	...
	<a style="color:red;" href="../controller/appointments-controller.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
