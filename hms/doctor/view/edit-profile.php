...
<p><b>Profile Reg. Date: </b></p>
<p><b>Profile Last Updation Date: </b></p>
...
<div class="form-group">
		...
		<input type="text" name="docfees" class="form-control" required="required"  value="" >
														</div>
...
<div class="form-group">
					...
					<input type="text" name="doccontact" class="form-control" required="required"  value="">
														</div>
