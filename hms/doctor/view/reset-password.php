...
if (!isset($_SESSION['email_reset']) || $_SESSION['email_reset'] == '') {
   die('Link is not found');
}
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					<form class="form-login" name="passwordreset" method="post" action="../controller/login-controller.php" ">
						<fieldset>
							<legend>
