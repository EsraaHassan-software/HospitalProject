									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th>Doctor's Name</th>
												<th class="hidden-xs">telephone Number</th>
...
<tbody>
    ...
    $d1 = new database();
$sql=mysqli_query($d1->GetConnection(),"select * from doctors");
    if($sql){
...
?>
    <tr>
        ...
        <td><?php echo $row['doctorName'];?></td>
												<td class="hidden-xs"><?php echo $row['contactno'];?></td>
        <td class="hidden-xs"><?php echo $row['address'];?></td>
												<td class="hidden-xs"><?php echo $row['docEmail'];?></td>
        <td class="hidden-xs"><?php echo $row['docFees'];?></td>
	...
	<a style="color:red;" href="../controller/adddoctor-controller.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
												</div>
        </td> 
    </tr>
    	<?php 
